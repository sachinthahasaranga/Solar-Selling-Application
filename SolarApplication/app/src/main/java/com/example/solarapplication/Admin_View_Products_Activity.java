...
public class Admin_View_Products_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Admin_View_Products_Activity.this, Admin_Home_Activity.class);
                startActivity(intent);
                finish();
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
            }});
        ...
        approved.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Admin_View_Products_Activity.this, Admin_search_Products_Activity.class);
        ...
        all.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_View_Products_Activity.this, Admin_View_Products_Activity.class);
                startActivity(intent);
                overridePendingTransition(0,0);
            }
        });
    ...
    private void showPostData() {
        try {
            ...
            if (arrayList.isEmpty()) {
                Toast.makeText(Admin_View_Products_Activity.this, "No Products to display", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(Admin_View_Products_Activity.this, Admin_Home_Activity.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }else {
