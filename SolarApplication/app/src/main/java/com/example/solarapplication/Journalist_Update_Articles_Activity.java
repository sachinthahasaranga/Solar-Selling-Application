...
public class Journalist_Update_Articles_Activity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        Intent intent = new Intent(this, Journalist_Manage_Articles_Activity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_journalit_update_articles);
        DBHelper dbh = new DBHelper(this);
        Intent intent = getIntent();
        account = (Journalist) intent.getSerializableExtra("UserInfo");
        post = (Article) intent.getSerializableExtra("PostData");
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Journalist_Update_Articles_Activity.this, Journalist_Home_Activity.class);
                intent.putExtra("UserInfo", account);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
            }});
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ProductName.isEmpty()){
                    ...
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(Journalist_Update_Articles_Activity.this);
                    alertDialog.setTitle("Confirm...");
                    alertDialog.setMessage("Are you sure you want Update this Article");
                    ...
                    alertDialog.setPositiveButton("YES",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Boolean insert = dbh.updateArticlesData(post.getId(),img, ProductName,  Description,"Pending",account.getId());
                                    if (insert == true) {
                                        Toast.makeText(Journalist_Update_Articles_Activity.this, "Article Published Successfully", Toast.LENGTH_SHORT).show();

                                        Intent intent = new Intent(Journalist_Update_Articles_Activity.this, Journalist_Manage_Articles_Activity.class);
                                        intent.putExtra("UserInfo", account);
                                        startActivity(intent);
                                        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                                    } else {
