...
public class Admin_search_Supplier_Activity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        Intent intent = new Intent(this, Admin_View_Supplier_Activity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_search_supplier);
        ...
        arrayList = dbh.searchAllsuppliers(searchQuery);
        if (arrayList.isEmpty()) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage("Searched Supplier Not Found.")
                    .setCancelable(false)
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent intent = new Intent(Admin_search_Supplier_Activity.this, Admin_View_Supplier_Activity.class);
                            startActivity(intent);
                            overridePendingTransition(0, 0);
                        }
                    });
        ...
        approved.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Admin_search_Supplier_Activity.this, Admin_search_Supplier_Activity.class);
